...
export default function Hero() {
  return (
    <section id="hero" className="w-full min-h-[calc(100vh-73px)] flex items-center justify-center relative pb-32 sm:pb-48 md:pb-64">
      ...
      <div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-1/2 w-full px-6 z-10">
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute inset-0 -z-10 bg-gradient-to-b from-white via-white/50 to-transparent rounded-2xl blur-xl" />
